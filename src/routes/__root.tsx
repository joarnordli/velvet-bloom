...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "mittpunkt" },
      { name: "description", content: "Eksklusivt, anonymt og norsk. En diskret, personvern-først PWA." },
      { name: "author", content: "mittpunkt" },
      { name: "theme-color", content: "#161210" },
      // iOS / Android standalone PWA polish (status bar, home-screen title).
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "mittpunkt" },
      { property: "og:title", content: "mittpunkt" },
      { property: "og:description", content: "Eksklusivt, anonymt og norsk." },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "/icons/icon-512.png" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "mittpunkt" },
      { name: "twitter:description", content: "Eksklusivt, anonymt og norsk." },
